...
class OpenTsdbMeterRegistryFieldToStringTest {
    ...
    void testWithEnglishLocale() {
        ...
        OpenTsdbMeterRegistry instance = new OpenTsdbMeterRegistry(k -> null, new MockClock());

        OpenTsdbMeterRegistry.Field field = instance.new Field("value", 0.01);
    ...
    void testWithEnglishLocaleWithLargerResolution() {
        ...
        OpenTsdbMeterRegistry.Field field = instance.new Field("value", 0.0000009);
